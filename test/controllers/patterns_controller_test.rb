...
class PatternsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pattern" do
    assert_difference('Pattern.count') do
      post patterns_url, params: { pattern: { avatar: @pattern.avatar, description: @pattern.description, mix: @pattern.mix, name: @pattern.name, status: @pattern.status, title: @pattern.title } }
    end
  ...
  test "should update pattern" do
    patch pattern_url(@pattern), params: { pattern: { avatar: @pattern.avatar, description: @pattern.description, mix: @pattern.mix, name: @pattern.name, status: @pattern.status, title: @pattern.title } }
