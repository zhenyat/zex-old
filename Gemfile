...
gem 'react-rails'                               # https://rubygems.org/gems/react-rails/
...
gem 'jquery-rails'                              # Use jquery as the JavaScript library. Needed for Bootstrap
...
gem 'mini_magick', '~> 4.8'                     # https://github.com/minimagick/minimagick
