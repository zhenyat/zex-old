class PatternsController < ApplicationController
  ...
  after_action  :remove_icon_dir, only: :destroy
  # GET /patterns
  # GET /patterns.json
  def index
  ...
  private
    # Removesupload icon directory of a destroyed Pattern
    def remove_icon_dir
      dir = File.dirname(@pattern.icon.current_path)
    ...
    def pattern_params
      params.require(:pattern).permit(:name, :title, :mix, :description, :icon, :status, :remove_icon)
    end
end
